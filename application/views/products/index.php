		...
		if($products)
		{
			foreach($products as $rec):
				if($rec->group_id != $group_id)
				{
					...
					if($loop == 1) echo '<div id="group_'.$rec->group_id.'" class="group_div"><h2>'.$rec->group_title.'</h2><p>'.$rec->short_description.'</p><hr class="vertical-space3">' ;
					else echo '<hr class="vertical-space3"></div><div id="group_'.$rec->group_id.'" class="group_div"><h2>'.$rec->group_title.'</h2><p>'.$rec->short_description.'</p><hr class="vertical-space3">' ;
				}
		?>
