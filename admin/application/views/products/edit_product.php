			...
			<div class="box">
				...
				<div class="content">
					...
					<div class="row">
						...
						<br /><br /><textarea id="short_description" name="short_description" rows="" cols="" class="wysiwyg" style="height:50px;"><?php echo set_value("short_description", stripslashes($product_detail->short_description)) ; ?></textarea>
					</div>
                    <div class="row">
						<label>Description</label>
						<br /><br /><textarea id="description" name="description" rows="" cols="" class="wysiwyg" style="height:100px;"><?php echo set_value("description", stripslashes($product_detail->description)) ; ?></textarea>
					</div>
                    <div class="row">
						<label>Formula <a href="javascript:void(0);" class="modalopen">Help!</a></label>
						<br /><br /><textarea id="formula" name="formula" rows="" cols="" class="wysiwyg" style="height:100px;"><?php echo set_value("formula", stripslashes($product_detail->formula)) ; ?></textarea>
					</div>
				</div>
			</div>
		</div>
        <div class="half">
			<div class="box">
				...
				<div class="content">
					...
					<div class="row">
						<label>Short Description</label>
                       	<br /><br /><textarea id="short_description_french" name="short_description_french" class="wysiwyg" rows="" cols="" style="height:50px;"><?php echo set_value("short_description_french", stripslashes($product_detail->short_description_french)) ; ?></textarea>
					</div>
                    <div class="row">
						<label>Description</label>
						<br /><br /><textarea id="description_french" name="description_french" class="wysiwyg" rows="" cols="" style="height:100px;"><?php echo set_value("description_french", stripslashes($product_detail->description_french)) ; ?></textarea>
					</div>
                    <div class="row">
						<label>Formula <a href="javascript:void(0);" class="modalopen">Help!</a></label>
						<br /><br /><textarea id="formula_french" name="formula_french" class="wysiwyg" rows="" cols="" style="height:100px;"><?php echo set_value("formula_french", stripslashes($product_detail->formula_french)) ; ?></textarea>
					</div>
				</div>
			</div>
		</div>
