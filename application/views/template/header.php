...
<div class="top-bar">
	<div class="container">
		...
		<div class="socailfollow">
        	<a href="<?php echo base_url("http://facebook.com/InnoviteHealth") ; ?>" class="facebook"><i class="icomoon-facebook"></i></a>
        	<a href="<?php echo base_url("http://twitter.com/InnoviteCanada") ; ?>" class="twitter"><i class="icomoon-twitter"></i></a>
            <a href="<?php echo base_url("http://www.youtube.com/user/innovitecanada") ; ?>" class="youtube"><i class="icomoon-youtube"></i></a>
            ...
            <a href="<?php echo base_url("https://plus.google.com/101210095383195582761") ; ?>" class="google"><i class="icomoon-google"></i></a>
        </div>
	</div>
</div>
