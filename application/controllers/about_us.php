...
class About_us extends CI_Controller
{
	...
	public function index()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 1), "dynamic_content") ;
	...
	public function innovite_in_the_community()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 2), "dynamic_content") ;
	...
	public function news_and_press()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 3), "dynamic_content") ;
	...
	public function innovite_igniters()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 4), "dynamic_content") ;
	...
	public function staff_picks()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 5), "dynamic_content") ;
	...
	public function careers()
	{
		...
		$data["dynamic_content"] = $this->model1->get_one(array("id" => 6), "dynamic_content") ;
