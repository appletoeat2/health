<div id="right">
	<div class="section">
		<div class="box">
			<div class="title">Inputs and textareas<span class="hide"></span></div>
			<div class="content">
				<form action="">
					<div class="row">
    ...
    <div class="section">
		<div class="box">
			<div class="title">Form validation<span class="hide"></span></div>
			<div class="content">
    ...
    <div class="section">
		<div class="box">
			<div class="title">Inputs with filtering<span class="hide"></span></div>
			<div class="content">
				<form action="">
					<div class="row">
    ...
    <div class="section">
		<div class="box">
			<div class="title">Selectmenus and spinners<span class="hide"></span></div>
			<div class="content">
				<form action="">
					<div class="row">
    ...
    <div class="section">
		<div class="box">
			<div class="title">Datepicker and buttons<span class="hide"></span></div>
			<div class="content">
				<form action="">
					<div class="row">
